    ...
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='group relative'>
          ...
          {/* dropdown menu */}
          { token && 
            <div className='absolute group-hover:block transition-opacity hidden dropdown-menu right-0 pt-4'>
            <div className='flex flex-col bg-slate-100 gap-2 w-36 py-3 px-5 text-gray-500 rounded'>
        ...
        <Link to='/cart' className='relative'>
          ...
          <p className='absolute right-[-5px] bottom-[-5px] bg-red-500 text-white rounded-full w-4 h-4 flex items-center justify-center text-xs'>{getCartCount()}</p>
        </Link>
